...
namespace YoutubeSolution.ViewModels
{
    public class RegisterViewModel : BaseViewModel
    {
        ...
        private async void RegisterMethod()
        {
            ...
            string sql = "INSERT INTO user (email, password, fullname, old) VALUES ('" + this.EmailTxt + "','" + this.PasswordTxt + "','" + this.NameTxt + "','" + this.AgeTxt + "')";

            MySqlConnection conn = Conexion.Dbconexion();
            conn.Open();
            ...
            try
            {
              ...
              await  App.Current.MainPage.DisplayAlert("Info","guardado","OK");
            }
